...
<!DOCTYPE html>
<html>
<title><my:i18n zhText="系统首页" enText="Index Page"/></title>
  ...
  <%--
   ...
   <div data-options="region:'west',split:true,title:'<my:i18n zhText="菜单导航" enText="Menu Navigation"/>'" style="width:211px;padding-left:2px;padding-top:1px;">
		<div class="arrowlistmenu">
		    ...
		    <h3 class="menuheader expandable"><my:i18n zhText="${menu.chFuncName}" enText="${menu.chFuncName}"/></h3>
			  <ul class="categoryitems" style="border: 0">
			     <c:forEach items="${menu.subList}" var="subMenu">
			        <c:set value="${subMenu.subList}" var="subList"></c:set>
			           ...
			           %>
			              <li>
			                <a style="cursor: pointer;" class="subexpandable">
			                  <img src="${ctx }/js_css_image/images/1.gif" alt="1" width="4" height="6" /><my:i18n zhText="${subMenu.chFuncName}" enText="${subMenu.chFuncName}"/>
			                </a>
			                 <ul class="subcategoryitems" style="margin-left:5px"> 
			                      <c:forEach items="${subMenu.subList}" var="subSubMenu">
			                         <li id="${subSubMenu.id }">
			                            <a href="javascript:void(0)"style="cursor: pointer;" onclick="focusMenu('${subSubMenu.id}');"src="${subSubMenu.chFuncPath}" class="aa"
			                            frameName="${subMenu.chFuncName}"}">
					                      &nbsp;&nbsp;&nbsp;<img src="${ctx }/js_css_image/images/4.gif" alt="1" width="4" height="6" /><my:i18n zhText="${subSubMenu.chFuncName}" enText="${subSubMenu.chFuncName}"/>
					                    </a>
				                    </li> 
			                      </c:forEach>
			                 </ul>
			           ...
			           %>
				           <li id="${subMenu.id}">
					        <a  href="javascript:void(0)" style="cursor: pointer;" onclick="focusMenu('${subMenu.id}');"src="${subMenu.chFuncPath}"class="aa"
					         frameName="${subMenu.chFuncName}">
					         <img src="${ctx }/js_css_image/images/1.gif" alt="1" width="4" height="6" /><my:i18n zhText="${subMenu.chFuncName}" enText="${subMenu.chFuncName}"/>
					        </a>
					      </li> 
