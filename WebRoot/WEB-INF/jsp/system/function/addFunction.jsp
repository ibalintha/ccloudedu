					...
					<td>
						 <div align="center" id="uldiv">
							<ul >
								...
								<li id="current"><a href="${ctx }/system/func_add.do?id=${id }"><span><my:i18n zhText="新增下级菜单" enText="Add A New Menu"/></span></a></li>
							</ul>
						    </div>
						</td>
					</tr>
          ...
          <tr>
            ...
            <td>
            	<c:forEach items="${chModelfs}" var="model">
            		<input type="checkbox" name="ids" value="${model.id}"/>${model.chModlName }
            	</c:forEach>
          </tr>
           <tr>
