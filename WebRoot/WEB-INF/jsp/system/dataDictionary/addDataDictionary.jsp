	 ...
	 $(function() {
		 $("#submitBtn").submitForm({ 
			 ...
			 onComplete:function(id){
				parent.addNode('contentIframe',$("#parentId").val(),id,$("#${locale.language}DdName").val(),"/system/datadictionary_update.do?id="+id);
			 }
	     });
	 });
	</script>
			...
			<td>
				<div align="center" id="uldiv">
					<ul>
						...
						<li id="current"><a href="${ctx }/system/datadictionary_add.do?id=${id }"><span><my:i18n zhText="新增下级参数" enText="Add A New Param"/></span></a></li>
					</ul>
				</div>
			 </td>
			</tr>
