	...
	<script type="text/javascript">
		...
		$(function(){
		 ...
		 function deleteUploadFile(id){
		      if(confirm("您确定要删除吗")){
		          window.location.href="${ctx}/system/user_deleteUserPicture.do?pictureOnly=yes&uploadFileId="+id;
	          }
	     }
...
<div id="result" align="center" style="color: red;"></div>
    <form method="post" action="${ctx}/system/user_uploadUserPicture.do" id="ufForm" enctype="multipart/form-data">
