     ...
     <script type="text/javascript">
      ...
      /*  $(function(){
        ...
        $("#submitBtn").click(function(){
           var chClasId= $("#classid").val(); 
           var isLast=$("#isLast").val();
        var tolisturl = "${ctx}/student/enrolment_list.do?chClasId="+chClasId+"&isLast="+isLast;
        $("#studentForm").submit(); 
...
<div class="bodybox">
<div class="phead">
	<div class="pheadposition"><my:i18n zhText="当前位置" enText="Current Position"/>： <my:i18n zhText="学籍管理" enText="User Mgt"/> - <my:i18n zhText="重新分班" enText="Add A New User"/></div>
	...
	<div class="clear"></div>
	    ...
	    <div id="result" align="center" style="color: red"></div>
		  <form id="studentForm" action="student/enrolment_reOrderSave.do" method="post">
		  <input type="hidden" id="ids"name="ids"value="${ids}"> 
		  <input type="hidden" id= "classid" name="classid" value="${chClasId}">
		  <input type="hidden" id= "isLast" name="isLast" value="${isLast}">
