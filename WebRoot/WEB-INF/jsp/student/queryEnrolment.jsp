   ...
   function cancel(){
	var api = frameElement.api;
	  api.close();
        ...
        function submita(){
        var chScroSchcode = $("#chScroSchcode").val();      
        var chScroName=$("#chScroName").val();
        chScroName = encodeURI(encodeURI(chScroName));
        
        /* var chStudSex=$("#chStudSex").val();
        chStudSex = encodeURI(chStudSex);
        chStudSex = encodeURI(chStudSex); */
        var chClasId=$("#chClasId").val();
        var tolisturl = "${ctx}/student/enrolment_list.do?chScroSchcode="+chScroSchcode+"&chScroName="+chScroName+"&chClasId="+chClasId;
...
<div class="phead">
	...
	<div class="clear"></div>
	    ...
	    <div id="result" align="center" style="color: red"></div>
		  <form id="studentForm" action="${ctx}/student/enrolment_list.do" method="post">
		   ...
		   <table style="width:100% "class="ltable">
		    <thead class="ltablehead">
	          ...
	          <tr>
	              ...
	              <td>
	               <input type="text" name="chScroSchcode" id="chScroSchcode"
					value="" />
	              </td>
	          </tr>
           <tr>
	              ...
	              <td>
	               <input type="text" name="chScroName" id="chScroName"
					value="" />
	              </td>
	          </tr>
	         <!--  <tr>
