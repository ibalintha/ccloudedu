 ...
 * @author wade
 */ 
@Controller("system.action.DeskSettingActionCh")
@Scope("prototype")
public class DeskSettingActionCh extends BaseAuthAction{
...
//	private OaArticleService oaArticleService;
	...
	public String execute() throws Exception {
		ChUser user =  userService.get(Sessions.getChUser().getId());
		String myselfDesk =  user.getChUserDesk();
		//如果用户没有设置桌面，则使用该用户所属角色的桌面
		if(StringUtils.isEmpty(myselfDesk)){
			myselfDesk = Sessions.getChUser().getChRole().getChRoleDeskSetting();
		}
