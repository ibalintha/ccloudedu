...
public class FuncAction extends BaseCrudAction<ChFunction>{
	...
	public String save() throws Exception {
		...
		if(id==null){
            ...
            List<ChModelfunc> chModelfuncs = modelFuncService.findList("system.findFuncsByModel", new FastMap().newHashMap().set("funcId", funcId));
            for (ChModelfunc mf : chModelfuncs) {
            	modelFuncService.deleteById(mf.getId());
            }
