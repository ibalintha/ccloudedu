	...
	public String processResult() {
		...
		if("new page style".equals(style)){
			...
			if(LocaleUtils.EN_US.equals(LocaleUtils.getLocale())){
				...
				String pageSize_10="",pageSize_20="",pageSize_50="",pageSize_100="" ,pageSize_500="",pageSize_1000="" ,pageSize_2000="";
				...
				else if(pageSize==500){pageSize_500="selected=\"selected\"";}
				else if(pageSize==1000){pageSize_1000="selected=\"selected\"";}
				else if(pageSize==2000){pageSize_2000="selected=\"selected\"";}
				...
				sb.append("<option value=\"10\" "+pageSize_10+">10</option>" +
						...
						"<option value=\"500\" "+pageSize_500+">500</option>" +
						"<option value=\"1000\" "+pageSize_1000+">1000</option>" +
						"<option value=\"2000\" "+pageSize_2000+">1000</option>\n");
				...
				sb.append("<option value=\"10\" "+pageSize_10+">10</option>" +
						...
						"<option value=\"500\" "+pageSize_500+">500</option>" +
						"<option value=\"1000\" "+pageSize_1000+">1000</option>" +
						"<option value=\"2000\" "+pageSize_2000+">2000</option>\n");
				sb.append("</select>条\n");
			}
		}
		//js排序
