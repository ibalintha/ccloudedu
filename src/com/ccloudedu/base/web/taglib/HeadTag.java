...
public class HeadTag extends BodyTagSupport{
	...
	public int doStartTag() throws JspException{
		...
		result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/css/easyui/jquery-1.7.2.min.js\"></script>\n");
		result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/css/easyui/jquery.easyui.min.js\"></script>\n");
		result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/base/jquery.ccloudedu.utils-1.0.js\"></script>\n");
		...
		if(true/*crud*/){
			...
			result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/base/jquery.ccloudedu.crud.init-1.0.js\"></script>\n");
			result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/base/jquery.ccloudedu.crud-1.0.js\"></script>\n");
