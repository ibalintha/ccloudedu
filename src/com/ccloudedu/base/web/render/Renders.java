...
import com.ccloudedu.base.utils.bean.Objects;
...
public class Renders {
	...
	//保存成功后，返回的json提示信息
	public static final JsonResult GENERATE_SUCCESS = new EasyUiResult(LocaleUtils.getLocaleText("生成成功", "Generate Success"));
	/**
	 * 输出html/文本
	 * @throws Exception 
	 */
